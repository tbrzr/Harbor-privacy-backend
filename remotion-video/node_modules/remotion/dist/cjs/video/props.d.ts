...
type NativeOffthreadVideoProps = Omit<React.HTMLAttributes<HTMLElement>, keyof MandatoryOffthreadVideoProps | keyof OptionalOffthreadVideoProps | keyof CommonVideoProps | keyof DeprecatedOffthreadVideoProps | 'onError'> & Record<`data-${string}`, string | undefined>;
export type AllOffthreadVideoProps = MandatoryOffthreadVideoProps & OptionalOffthreadVideoProps & CommonVideoProps & NativeOffthreadVideoProps;
export type RemotionOffthreadVideoProps = MandatoryOffthreadVideoProps & Partial<OptionalOffthreadVideoProps> & Partial<CommonVideoProps> & Partial<DeprecatedOffthreadVideoProps> & NativeOffthreadVideoProps;
export type OnVideoFrame = (frame: CanvasImageSource, now?: DOMHighResTimeStamp, metadata?: VideoFrameCallbackMetadata) => void;
export {};
