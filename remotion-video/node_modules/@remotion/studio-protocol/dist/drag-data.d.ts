...
import { type AssetDragPreviewMetadata, type ComponentDragPreviewMetadata, type CompositionDragPreviewMetadata, type EffectDragPreviewMetadata, type ElementDragPreviewMetadata, type RenderOutputDragPreviewMetadata, type SfxDragPreviewMetadata } from './drag-preview-metadata';
...
export type MakeDragDataInput = MakeAssetDragDataInput | MakeComponentDragDataInput | MakeCompositionDragDataInput | MakeEffectDragDataInput | MakeElementDragDataInput | MakeRenderOutputDragDataInput | MakeSfxDragDataInput;
...
export type RemotionDragData = AssetDragData | ComponentDragData | CompositionDragData | EffectDragData | ElementDragData | RenderOutputDragData | SfxDragData;
