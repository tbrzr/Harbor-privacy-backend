...
exports.resolveFileInsideProject = exports.FileOutsideProjectError = void 0;
...
class FileOutsideProjectError extends Error {
}
exports.FileOutsideProjectError = FileOutsideProjectError;
const resolveFileInsideProject = ({ remotionRoot, fileName, action, }) => {
    ...
    if (fileRelativeToRoot === '..' ||
        ...
        throw new FileOutsideProjectError(formatOutsideProjectError({
            action,
            fileName,
            absolutePath,
